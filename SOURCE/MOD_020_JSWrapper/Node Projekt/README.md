...
|callback|The callback function that should handle the result of this function call. If no callback is specified the result will be returned by using a return statement.<br />*See [How to handle the result of a function call](#how-to-handle-the-result-of-a-function-call) for more information.*<br />**Default value:** null|
#### Return value
...
````
wrapper.appendToInstanceHierarchy(path, instanceName, internalElement = null, callback = null);
````
#### Description
