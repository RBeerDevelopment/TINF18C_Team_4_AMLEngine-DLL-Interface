...
namespace altova
{
	...
	extern const FacetCheck* FacetCheck_string_length = &FacetCheckInstance_string_length;
	extern const FacetCheck* FacetCheck_string_minLength = &FacetCheckInstance_string_minLength;
	extern const FacetCheck* FacetCheck_string_maxLength = &FacetCheckInstance_string_maxLength;
	extern const FacetCheck* FacetCheck_string_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_string_enumeration = &FacetCheckInstance_string_enumeration;
	...
	extern const FacetCheck* FacetCheck_hexBinary_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_hexBinary_enumeration = &FacetCheckInstance_string_enumeration;
	...
	extern const FacetCheck* FacetCheck_base64Binary_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_base64Binary_enumeration = &FacetCheckInstance_string_enumeration;

	// facet checking for xs:decimal
	extern const FacetCheck* FacetCheck_decimal_totalDigits = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_fractionDigits = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_minExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_decimal_pattern = &FacetCheckInstance_Success;

	// facet checking for xs:boolean
	extern const FacetCheck* FacetCheck_boolean_pattern = &FacetCheckInstance_Success;

	// facet checking for xs:float
	extern const FacetCheck* FacetCheck_float_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_float_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_float_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_float_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_float_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_float_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:double
	extern const FacetCheck* FacetCheck_double_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_double_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_double_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_double_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_double_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_double_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:duration
	extern const FacetCheck* FacetCheck_duration_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_duration_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_duration_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_duration_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_duration_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_duration_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:dateTime
	extern const FacetCheck* FacetCheck_dateTime_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_dateTime_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_dateTime_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_dateTime_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_dateTime_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_dateTime_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:time
	extern const FacetCheck* FacetCheck_time_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_time_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_time_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_time_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_time_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_time_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:date
	extern const FacetCheck* FacetCheck_date_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_date_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_date_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_date_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_date_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_date_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:gYear
	extern const FacetCheck* FacetCheck_gYear_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYear_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYear_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYear_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYear_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYear_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:gMonth
	extern const FacetCheck* FacetCheck_gMonth_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonth_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonth_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonth_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonth_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonth_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:gDay
	extern const FacetCheck* FacetCheck_gDay_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gDay_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gDay_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gDay_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gDay_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gDay_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:gYearMonth
	extern const FacetCheck* FacetCheck_gYearMonth_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYearMonth_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYearMonth_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYearMonth_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYearMonth_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gYearMonth_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:gMonthDay
	extern const FacetCheck* FacetCheck_gMonthDay_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonthDay_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonthDay_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonthDay_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonthDay_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_gMonthDay_minExclusive = &FacetCheckInstance_Success;

	// facet checking for xs:anySimpleType: these will all return success
	extern const FacetCheck* FacetCheck_anySimpleType_pattern = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_enumeration = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_length = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_minLength = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_maxLength = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_maxInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_maxExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_minInclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_minExclusive = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_totalDigits = &FacetCheckInstance_Success;
	extern const FacetCheck* FacetCheck_anySimpleType_fractionDigits = &FacetCheckInstance_Success;
	...
	public:
		...
		{
			return CoreTypes::CastToString((__int64)(v));			
		}
	};
