...
public: // protected:
	...
	xercesc::DOMBuilder* GetBuilder();
	xercesc::DOMWriter* GetWriter();
...
public:
	...
	void Save(const tstring& sURI, CNode& rNode, bool bQualified = true, bool bPrettyPrint = true);
	tstring SaveToString(CNode& rNode, bool bQualified = true, bool bPrettyPrint = true);
